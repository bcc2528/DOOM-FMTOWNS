...
#if 0
{
    ...
    num = FixedMul(projection,finesine[( ANG90 + (visangle-rw_normalangle) ) >> ANGLETOFINESHIFT]) << detailshift;
    den = FixedMul(rw_distance,finesine[( ANG90 + (visangle-viewangle) ) >> ANGLETOFINESHIFT]);
...
void R_ExecuteSetViewSize (void)
{
    ...
    viewwidth_cp = viewwidth >> 1;
    viewheight_cp = viewheight << 16;
    viewheight_cp = viewheight_cp | viewheight;
